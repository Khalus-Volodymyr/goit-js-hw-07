...
// кількістю елементів і очищатися значення в інпуті.При
// повторному натисканні на кнопку Create поверх старої
// колекції має рендеритись нова.Після натискання на кнопку
...
// Після кліку на кнопку Create, якщо в input значення поза межами
//  діапазону 1 - 100, нічого не відбувається
// Після кліку на кнопку Create в div#boxes за одну операцію
// додається така кількість різнокольорових квадратів, яка
// вказана в input.Значення input очищається
...
// const createButton = controlsContainer.querySelector("button[data-create]");
// const destroyButton = controlsContainer.querySelector("button[data-destroy]");
...
//todo "Пробачте в мене не получилось, але я її обов'язково зроблю"
